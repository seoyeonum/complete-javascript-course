...
// → ['fetch', 'swimming', 'running', 'fetch', ... , 'agility', 'fetch']
...
const heaviestFetchBreed = Math.max(...fetchWeights); // spread 연산자를 활용하여 숫자 나열

console.log(fetchWeights); // → [32, 24, 28, 12, 18]
console.log(heaviestFetchBreed); // → 32
